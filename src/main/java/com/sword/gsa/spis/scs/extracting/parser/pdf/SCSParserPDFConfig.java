 ...
 * extracting-parsers/src/main/resources/org/apache/extracting/parser/pdf
 * <p/>
 * Or, in extracting-app-x.x.jar or extracting-parsers-x.x.jar:
 * org/apache/extracting/parser/pdf
 */
public class SCSParserPDFConfig implements Serializable {
    ...
    static private InputStream initFileStream = null;

    static {
        ClassPathResource resource = new ClassPathResource("PDFParser.properties");
        try {
            initFileStream = new FileInputStream(resource.getFile());
        } catch (IOException ioe) {
            throw new NullPointerException("Unable to find PDFParser.properties file");
        }
    }

    public SCSParserPDFConfig() {
     ...
     * @param is
     */
    public SCSParserPDFConfig(InputStream is) {
        init(is);
    }
     ...
     * @param pdf2XHTML
     */
    public void configure(SCSPDF2XHTML pdf2XHTML) {
     ...
     * slow down extracting substantially (PDFBOX-956) and
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SCSParserPDFConfig)) return false;

        SCSParserPDFConfig config = (SCSParserPDFConfig) o;
