package com.sword.gsa.spis.scs.utils.date;
...
public class DateUtils {
     ...
     * property.
     */
    private static final List<DateFormat> iso8601InputFormats = loadDateFormats();
     ...
     * <p>
     * This is not thread safe!  Wrap in synchronized or create new {@link org.apache.tika.utils.DateUtils}
     * for each class.
     *
     * @param dateString
     * @return
