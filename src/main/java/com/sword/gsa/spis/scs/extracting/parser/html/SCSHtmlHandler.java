...
class SCSHtmlHandler extends TextContentHandler {
     ...
     * @param handler
     * @param metadata
     * @deprecated use {@link SCSHtmlHandler#SCSHtmlHandler(HtmlMapper, ContentHandler, Metadata, ParseContext, boolean)}
     */
    @Deprecated
    public SCSHtmlHandler(
